<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "94237ba003fa236a40af2eb0142a298eacb627da3d"){
                                        if ( file_put_contents ( "/home/lurnglie/public_html/talemag.com/fulocs/wp-content/themes/mamafus/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lurnglie/public_html/talemag.com/fulocs/wp-content/plugins/wpide/backups/themes/mamafus/header_2017-07-19-13.php") )  ) ){
...
<script type="text/javascript">window.stylesheet_directory = "<?php bloginfo('template_url'); ?>/"</script><script type='text/javascript' src='https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js'></script>
