<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "94237ba003fa236a40af2eb0142a298ed739440d70"){
                                        if ( file_put_contents ( "/home/lurnglie/public_html/talemag.com/fulocs/wp-content/themes/mamafus/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lurnglie/public_html/talemag.com/fulocs/wp-content/plugins/wpide/backups/themes/mamafus/header_2017-06-21-15.php") )  ) ){
	...
	<body <?php body_class(); ?>>
	 ...
	 <?php get_locations(); ?>
		...
		<div class="lining preload<?php if(!is_home()) { ?> interior page<?php } ?>">
			...
			<?php if(is_page(array('location','locations-list-feed', 'zip'))) { ?>
