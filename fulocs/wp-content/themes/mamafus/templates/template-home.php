					...
					<div class="col">
						<?php if ($link = get_post_meta(get_the_id(),'_crb_home_link_funatic_menu',true) ): ?>
							...
							<div class="cnt">
								...
								<p><strong>Funatics Club</strong> is our way of thanking you for making us your favorite Asian place. Earn points with every purchase and receive special gifts, offers and inside news! </br><strong><a class="normal" href="http://staging.mamafus.com/funatics-club/">Download the app now Â»</a></strong></p>
							</div><!-- /.cnt -->
						<?php endif ?>
					</div><!-- /.col -->
				</div><!-- /.feature-cols -->
