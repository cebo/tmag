...
Carbon_Container::factory('theme_options', 'Theme Options')
	->add_fields(array(
		Carbon_Field::factory('separator', 'sep2', 'Socials Properties'),
		Carbon_Field::factory('text', 'crb_socials_facebook', 'Facebook'),
		Carbon_Field::factory('text', 'crb_socials_twitter', 'Twitter'),
		Carbon_Field::factory('text', 'crb_socials_youtube', 'YouTube'),
		Carbon_Field::factory('text', 'crb_socials_gplus', 'Google+'),
		Carbon_Field::factory('text', 'crb_socials_pinterest', 'Pinterest'),
		Carbon_Field::factory('text', 'crb_socials_instagram', 'Instagram'),

		Carbon_Field::factory('separator', 'sep3', 'Footer Feedback Properties'),
		Carbon_Field::factory('text', 'crb_newsletter_label', 'Label'),
		Carbon_Field::factory('rich_text', 'crb_newsletter_content', 'Content'),

		Carbon_Field::factory('separator', 'sep1', 'Misc'),
...
Carbon_Container::factory('theme_options', 'Twitter Settings')
	...
	->add_fields(array(
		Carbon_Field::factory('html', 'twitter_settings_html')
			...
			'),
		Carbon_Field::factory('text', 'twitter_uname')
			->set_default_value(''),
