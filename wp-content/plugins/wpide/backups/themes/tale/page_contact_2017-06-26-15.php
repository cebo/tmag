<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3f687f17b14319eecac3b9394eb81f65b88328e996"){
                                        if ( file_put_contents ( "/home/lurnglie/public_html/talemag.com/wp-content/themes/tale/page_contact.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lurnglie/public_html/talemag.com/wp-content/plugins/wpide/backups/themes/tale/page_contact_2017-06-26-15.php") )  ) ){
        ...
        <div class="lining">
			...
			<article class="content">
		    	...
		    	<form method="post" action="<?php bloginfo('template_url'); ?>/library/contact.php" name="cform" id="cform" class="contacto cform sleek">
		    			...
		    			<textarea style="background-color: #fff" class="lonely" name="comments" placeholder="<?php _e('Your Message*','misfitlang'); ?>" id="commentlys"></textarea>
