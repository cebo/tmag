<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "c7e546ef1c90f2ef8c113890cec1b982ea35bd327c"){
                                        if ( file_put_contents ( "/home/lurnglie/public_html/talemag.com/wp-content/themes/tale/index.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lurnglie/public_html/talemag.com/wp-content/plugins/wpide/backups/themes/tale/index_2017-05-29-20.php") )  ) ){
		...
		<section class="primo">
			...
			<div class="story-container">
				...
				<div class="story-left">
					...
					<p>Emotion binds us collectively as humans, yet is a constant reminder just how isolated we are in our individual experiences. Submissions should lean into those emotional experiences and incite us to react in kind and to empathize. Submission are below, and you can preorder this volume today!</p>
					<br>
		...
		<p class="slipped">Popular Genres: Literary Fiction, Fantasy, Science Fiction, Young Adult, Mystery Horror, Satire, Adventure</p>
			...
			<div id="submissions" class="container goalie">
				...
				<div class="hellofromtale" style="padding-top: 50px;">
						...
						<h1>Submissions</h1>
						<h3>Photographers can USE <br><span>#TALEMAG</span> ON INSTAGRAM</h3>
						<br><br>
