<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "c7e546ef1c90f2ef8c113890cec1b982e902e8672a"){
                                        if ( file_put_contents ( "/home/lurnglie/public_html/talemag.com/wp-content/themes/tale-beta/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lurnglie/public_html/talemag.com/wp-content/plugins/wpide/backups/themes/tale-beta/header_2017-05-19-04.php") )  ) ){
			...
			<section class="intro">
				...
				<div class="full-bg" data-vide-bg="<?php bloginfo ('template_url'); ?>/video/tale">
					...
					<div class="floating-copy">
						...
						<h4>Instagram photos reimagined into stories. Stories retold as films</h4>
