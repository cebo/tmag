...
function misfit_add_admin() {
    ...
    $tt_page = add_object_page($themename, $themename, 'administrator', 'misfit','misfit_options_page','../wp-content/themes/scribe/options/images/icon_options.png');
        ...
        <div class="options_header">
	    	...
	    	<center><img src="<?php echo get_template_directory_uri() ?>/options/images/littlehenry.png" style="width: 137px; margin-left: 0px; margin-top: -19px;" /></center>
	   	 	<div class="theme_name">
	   	 		<span style="margin-top: 5px; margin-right: 00px;">Scribe<small> 1.3</span><strong style="margin: 10px 0;">Misfit Themes Framework 2.03</strong></small>
