			...
			<article class="content">
				...
				<div class="post-intro">
					...
					<div class="socials">
		       		...
		       		<p><?php _e('Sorry, friend, if you have found this page it either means the internet has failed you or that you will have to try your search again. ', 'cebolang'); ?><?php _e('Head over to our ', 'cebolang'); ?><a href="<?php bloginfo('url'); ?>"><?php _e('home page ', 'cebolang'); ?></a><?php _e('or you can visit any of the links below.', 'cebolang'); ?><br>
		       		<br>
		       		
		       			<?php if(get_option('misfit_facebook')) { ?>
						<a class="button" href="http://facebook.com/<?php echo get_option('misfit_facebook'); ?>" target="_blank"><?php _e('Friend On Facebook','cebolang'); ?></a>
						<?php } ?>
						<?php if(get_option('misfit_twitter')) { ?>
						<a class="button" href="http://twitter.com/<?php echo get_option('misfit_twitter'); ?>" target="_blank"><?php _e('Follow On Twitter','cebolang'); ?></i></a>
						<?php } ?>
						<?php if(get_option('misfit_pinterest')) { ?>
						<a class="button" href="http://www.pinterest.com/<?php echo get_option('misfit_pinterest'); ?>" target="_blank"><?php _e('Pin On Pinterest','cebolang'); ?></i></a>
						<?php } ?>
						<?php if(get_option('misfit_dribbble')) { ?>
						<a class="button" href="https://dribbble.com/<?php echo get_option('misfit_dribbble'); ?>" target="_blank"><?php _e('See On Dribbble','cebolang'); ?></i></a>
						<?php } ?>
						<?php if(get_option('misfit_googleplus')) { ?>
						<a class="button" href="https://plus.google.com/+<?php echo get_option('misfit_googleplus'); ?>" target="_blank"><?php _e('Hang Out On Google','cebolang'); ?></i></a>
						<?php } ?>
						<?php if(get_option('misfit_instagram')) { ?>
						<a class="button" href="http://instagram.com/<?php echo get_option('misfit_instagram'); ?>" target="_blank"><?php _e('Follow On Instagram','cebolang'); ?></i></a>	
						<?php } ?>
