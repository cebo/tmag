...
?>
	...
	<div id="comments"<?php if(isset($_GET['replytocom'])){ ?> class="openit"<?php } ?>>
	...
	<?php // You can start editing here -- including this comment! ?>
				...
				<?php if ( have_comments() ) { ?>
					...
					<h2>
						<?php
							printf( _n( '1 thought on &ldquo;%2$s&rdquo;', '%1$s responses on &ldquo;%2$s&rdquo;', get_comments_number(), 'cebolang' ),
					...
					<h2><?php _e('Leave a Reply', 'cebolang'); ?></h2>
					...
					<div class="usercomments">
						...
						<ul class="commentlist">
							...
							<?php wp_list_comments('avatar_size=80&type=comment&callback=format_comment'); ?>
						</ul>
